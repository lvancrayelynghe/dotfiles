...
-- Change to allow navigation sites with invalid or expired ssl certificates
...
search_engines = {
    ...
    duckduckgo  = "https://duckduckgo.com/?q=%s&t=debian",
    github      = "https://github.com/search?q=%s",
    google      = "https://google.fr/search?q=%s",
