...
menu_binds = {
    ...
    key({},          "s",       function (w) w.menu:move_down() end),
    key({},          "z",       function (w) w.menu:move_up()   end),
...
add_binds("all", {
    key({"Mod1"}, "Escape", "Return to `normal` mode.",
...
add_binds("normal", {
    ...
    key({}, "s", "Scroll document down.",
        function (w) w:scroll{ yrel =  scroll_step } end),

    key({}, "Up", "Scroll document up.",
        function (w) w:scroll{ yrel = -scroll_step } end),

    key({}, "z", "Scroll document up.",
        function (w) w:scroll{ yrel = -scroll_step } end),
    ...
    key({}, "r", "Go to the end of the document.",
        function (w) w:scroll{ y =  0 } end),

    key({}, "End", "Go to the top of the document.",
        function (w) w:scroll{ y = -1 } end),

    key({}, "R", "Go to the top of the document.",
        function (w) w:scroll{ y = -1 } end),
    ...
    -- Zooming
    key({"Control"}, "+", "Enlarge text zoom of the current page.",
        function (w, m) w:zoom_in(zoom_step * m.count) end, {count=1}),

    key({"Control"}, "-", "Reduce text zom of the current page.",
    ...
    key({}, "X", "Undo closed tab (restoring tab history).",
    ...
    key({"Control"}, "R", "Reload current tab (skipping cache).",
