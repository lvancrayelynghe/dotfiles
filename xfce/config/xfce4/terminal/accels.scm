...
(gtk_accel_path "<Actions>/terminal-window/goto-tab-1" "<Primary>ampersand")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-2" "<Primary>eacute")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-3" "<Primary>quotedbl")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-4" "<Primary>apostrophe")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-5" "<Primary>parenleft")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-6" "<Primary>minus")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-7" "<Primary>egrave")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-8" "<Primary>egrave")
(gtk_accel_path "<Actions>/terminal-window/goto-tab-9" "<Primary>underscore")
