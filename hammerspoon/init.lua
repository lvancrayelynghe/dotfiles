...
hs.hotkey.bind({"ctrl"}, "return",   function() hs.application.launchOrFocus("iTerm") end)
hs.hotkey.bind({"ctrl"}, "t",        function() hs.application.launchOrFocus("iTerm") end)
hs.hotkey.bind({"ctrl", "alt"}, "t", function() hs.application.launchOrFocus("iTerm") end)
...
hs.hotkey.bind({"ctrl"}, "c",        function() hs.application.launchOrFocus("Calendar") end)
hs.hotkey.bind({"ctrl"}, "p",        function() hs.application.launchOrFocus("Slack") end)
